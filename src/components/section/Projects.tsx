  ...
  const projects = [
    {
      ...
      description:
        "🏆 First Place Winner. An AI-powered blockchain marketplace where users securely publish, discover, and verify digital assets through decentralized ownership and wallet authentication.",
      technologies: [
        "React",
        "TypeScript",
        "Node.js",
    ...
    },
    {
      title: "Text2SQL",
      description:
        "Ask questions in plain English and instantly generate executable SQL. Fine-tuned open-source LLMs to significantly improve query accuracy across thousands of real-world examples.",
      technologies: [
        "Python",
        "Gemma-2B",
        "Mistral-7B",
    ...
    },
    {
      ...
      description:
        "Built a scalable search engine from scratch that crawls, indexes, ranks, and retrieves over 50,000 web pages with sub-300ms search latency.",
      technologies: [
        "Python",
        "Multithreading",
    ...
    },
    {
      ...
      description:
        "A personalized recommendation system that predicts what you'll enjoy next by learning from your viewing history and similarity patterns across thousands of movies.",
      technologies: [
        "Python",
        "Pandas",
        "NumPy",
